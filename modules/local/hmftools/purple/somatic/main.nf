process HMFTOOLS_PURPLE_SOMATIC {
    tag "$meta.id"
    ...
    output:
    tuple val(meta), path("*driver.catalog.germline.tsv"), emit: driver_catalog_germline_tsv
    ...
    tuple val(meta), path("*purple.germline.deletion.tsv"), emit: purple_germline_deletion_tsv
    ...
    """
    touch ${tumor}.driver.catalog.germline.tsv
    touch ${tumor}.driver.catalog.somatic.tsv
    touch ${tumor}.purple.cnv.gene.tsv
    touch ${tumor}.purple.cnv.somatic.tsv
    touch ${tumor}.purple.germline.deletion.tsv
    touch ${tumor}.purple.purity.range.tsv
    touch ${tumor}.purple.purity.tsv
    touch ${tumor}.purple.qc
    touch ${tumor}.purple.segment.tsv
    touch ${tumor}.purple.somatic.clonality.tsv
    touch ${tumor}.purple.sv.vcf.gz
    touch ${tumor}.purple.sv.vcf.gz.tbi
