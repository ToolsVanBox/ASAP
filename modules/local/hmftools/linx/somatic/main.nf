process HMFTOOLS_LINX_SOMATIC {
    ...
    def sample = meta.tumor_sample_id
    ...
    """
    touch ${sample}.linx.breakend.tsv
    touch ${sample}.linx.clusters.tsv
    touch ${sample}.linx.driver.catalog.tsv
    touch ${sample}.linx.drivers.tsv
    touch ${sample}.linx.fusion.tsv
    touch ${sample}.linx.links.tsv
    touch ${sample}.linx.svs.tsv
    touch ${sample}.linx.vis_copy_number.tsv
    touch ${sample}.linx.vis_fusion.tsv
    touch ${sample}.linx.vis_gene_exon.tsv
    touch ${sample}.linx.vis_protein_domain.tsv
    touch ${sample}.linx.vis_segments.tsv
    touch ${sample}.linx.vis_sv_data.tsv
