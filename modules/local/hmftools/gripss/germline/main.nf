process HMFTOOLS_GRIPSS_GERMLINE {
    tag "$meta.id"
    ...
    """
    touch ${prefix}.gripps.vcf.gz
    touch ${prefix}.gripps.vcf.gz.tbi
    touch ${prefix}.gripps.filtered.vcf.gz
    touch ${prefix}.gripps.filtered.vcf.gz.tbi
