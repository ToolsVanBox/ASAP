...
workflow VCF_STRUCTURAL_VARIANT_FILTRATION_GRIDSS_PURPLE_LINX {
  ...
  main:
    ...
    if ( params.run.vcf_germline_structural_variant_filtration ) {
    ...
    if ( params.run.vcf_somatic_structural_variant_filtration ) {
    ...
    if ( params.run.vcf_tumoronly_structural_variant_filtration ) {
